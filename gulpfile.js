...
*/
    ...
    var File_Name = 'html-podcast.zip';
    var CSS_Files = [
    ...
    './node_modules/multiple-audio-player-plugin/progres-bar.css',
    ];
    var JS_Files = [
    ...
    './node_modules/multiple-audio-player-plugin/player.min.js',
    './assets/js/app.js'
    ];
    ...
    './dist/production/assets/css/progres-bar.css',
    ...
    './dist/production/assets/js/player.min.js',
